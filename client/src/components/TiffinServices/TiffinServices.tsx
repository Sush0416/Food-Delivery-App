...
import { Calendar, Clock, Star, Users, Utensils, ChefHat, Heart, Award, Sparkles, Leaf, Wheat, Zap } from 'lucide-react'
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg p-8 mb-12">
          <div className="text-center">
            ...
            <p className="text-xl max-w-2xl mx-auto opacity-90">
              Enjoy fresh, home-cooked meals delivered daily. Choose from our variety of subscription plans with unique features.
            </p>
          </div>
        </div>
              ...
              <div key={service._id} className="bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 transition-transform duration-200">
                <div className="h-48 bg-gray-200 relative">
                  ...
                  <div className="absolute bottom-4 left-4 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-xs">
                    {service.deliveryTime} min delivery
                  </div>
                </div>
